...
/**
 * Fawry Pay Payment Gateway for woocommerce
 */

class WC_Fawry_Pay extends WC_Payment_Gateway
{
  ...
  public function __construct()
  {
    ...
    $this->method_title = __('Fawry Pay Payment Gateway', 'fawry');
    $this->method_description = __('Fawry Pay for your Order with any Credit or Debit Card or through Fawry Machines', 'fawry'); // will be displayed on the options page
    $this->description = $this->get_option('description', __('Fawry Pay for your Order with any Credit or Debit Card or through Fawry Machines', 'fawry'));
